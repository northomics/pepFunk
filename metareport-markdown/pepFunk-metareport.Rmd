...
This report is based on peptide-centric functional enrichment information as identified by pepFunk. Currently, pepFunk is specific to the human gut microbiome because it uses a curated peptide database. As such, these enrichment results will only be accurate from human gut microbiome data. *If you'd like to use your own peptide-centric functional database, please see the [Shiny app](https://shiny2.imetalab.ca/shiny/rstudio/pepFunk/)*.
